    ...
    return(
      ...
      <div className="movie-card"  >
          ...
          <div className="movie-content">
            ...
            <div className="movie-info" style={{margin:"0px;"}}>
                ...
                <div className="info-section">
                  <label>Score</label>
                  <p>{this.props.avr} /10</p>
                </div>
              
            </div>
            <div className="info-section pull-right">
                         
            {this.props.cattitle !=="MOVIES YOU MIGHT LIKE" &&
      <div>
         <button   className="venobox   btn-xs"  onClick={()=>this.handleSubmit(this.props.finalToAdd)} > ADD</button>
                           <Link to={`MyList/${the_movie_id}`} ><button  style={{backgroundColor:"#007bff", borderColor:"#007bff",color:"white"}}     className="venobox   btn-xs">
                           VIEW
                         </button> </Link>  
      </div>
      }
